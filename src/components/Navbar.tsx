                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <div className="space-y-1.5">
                                    <span className={`block h-0.5 w-5 bg-matrix-green-primary transition-transform ${isOpen ? 'translate-y-1.5 rotate-45' : ''}`} />
                                    <span className={`block h-0.5 w-5 bg-matrix-green-primary transition-opacity ${isOpen ? 'opacity-0' : 'opacity-100'}`} />
                                    <span className={`block h-0.5 w-5 bg-matrix-green-primary transition-transform ${isOpen ? '-translate-y-1.5 -rotate-45' : ''}`} />
                                </div>
                            </button>
                        </div>

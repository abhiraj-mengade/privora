        ...
        <div className="container-max max-w-5xl">
          ...
          >
            ...
            <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto">
              We separate money flow, coordination, and identity into distinct
              layers, each with its own threat model and guarantees.
            </p>
          </motion.div>
            ...
            <div className="space-y-6">
              <div className="border-l-[1.5px] border-matrix-green-primary/60 pl-6">
                ...
                <p className="text-gray-400">
                  All donations flow through Zcash shielded addresses
                  (Z-addresses), ensuring complete privacy for both sender and
                  recipient. Transaction amounts and parties remain encrypted
                  on-chain using zk-SNARKs.
                </p>
              </div>
              ...
              <div className="border-l-[1.5px] border-matrix-green-primary/60 pl-6">
                ...
                <p className="text-gray-400">
                  NEAR smart contracts handle donor intents, recipient
                  attestations, and impact Soulbound Tokens (SBTs). No sensitive
                  information is stored on-chain—only encrypted hashes and
                  boolean flags.
                </p>
              </div>
              ...
              <div className="border-l-[1.5px] border-matrix-green-primary/60 pl-6">
                ...
                <p className="text-gray-400">
                  Encrypted profiles are stored off-chain with searchable
                  attributes (skills, topics, coarse location). Matching uses
                  tag intersection without accessing raw identity data.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Donations are completely anonymous via Zcash shielded
                      transactions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-4 w-[1px] bg-matrix-green-primary/80" />
                    <span>
                      Receive non-transferable SBT proving impact without
                      revealing details
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-4 w-[1px] bg-matrix-green-primary/80" />
                    <span>
                      Pseudonymous profiles with encrypted sensitive data
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-4 w-[1px] bg-matrix-green-primary/80" />
                    <span>
                      zk-proofs verify credentials without revealing identity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-4 w-[1px] bg-matrix-green-primary/80" />
          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <h3 className="font-bold text-matrix-green-light mb-2">
                    {useCase.title}
                  </h3>
